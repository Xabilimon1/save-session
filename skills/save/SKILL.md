---
name: save
description: Use when finishing a Claude Code session or when user says "save session", "guarda la sesión", "fin de sesión", or invokes /save. Saves compressed session summary to x-brain Obsidian vault.
---
